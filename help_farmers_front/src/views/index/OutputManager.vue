<template>
  <el-card class="box-card">
    ...
    <el-row :gutter="20" class="search">
      <el-col :span="2">
            <el-button type="primary" @click="handleAdd">农产品出库</el-button>
      </el-col>
      <el-col :span="3">
    ...
    <el-dialog title="农产品出库" :visible.sync="dialogFormVisible" width="30%">
        <div class="el-dialog-div">
          <el-form :model="farmForm"  label-width="120px" :rules="rules" ref="ruleForm" class="demo-ruleForm">
            ...
            <el-form-item label="出库数量" prop="oNum" required>
                <el-input v-model="farmForm.oNum"></el-input>
            </el-form-item>
            <el-form-item label="出库人" prop="oPeople" required>
                <el-input v-model="farmForm.oPeople"></el-input>
            </el-form-item>
            <el-form-item label="出库人联系方式" label-width="130px" prop="oPhone" required>
                <el-input v-model="farmForm.oPhone"></el-input>
            </el-form-item>
...
export default {
  data () {
    return {
      ...
      rules: {
        ...
        oPeople: [
          { required: true, message: '请填写出库人', trigger: 'change' }
        ],
        oPhone: [
          { required: true, message: '请填写出库人联系方式', trigger: 'change' }
        ]
      },
      user: {}
    }
  ...
  methods: {
    ...
    handleAdd () {
      this.farmForm = {}
      this.farmForm.oPeople = this.user.trueName
      this.farmForm.oPhone = this.user.phone
